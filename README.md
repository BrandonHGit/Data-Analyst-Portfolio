...
## Tableau Dashboards
* **Global Youtube Statistics '23** - [Tableau](https://public.tableau.com/app/profile/brandon.hindman/viz/YoutubeGlobalStatistics23_Top10PACKED/Dashboard1?publish=yes): Utilizing the same dataset from Kaggle.com, I created a packed bubble chart of the top 10 channels based on subscription count and monthly revenue in order to compare channel types (music, entertainment, gaming, etc.).
